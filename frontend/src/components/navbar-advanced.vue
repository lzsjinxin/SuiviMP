...
<template>
    ...
    <div class="header-wrapper"> <!-- [Mobile Media Block] start -->
            ...
            <ul class="list-unstyled">
                    ...
                    <div class="dropdown-menu pc-h-dropdown drp-search">
                        <form class="px-3">
                            <div class="form-group mb-0 d-flex align-items-center">
                                <input ref="searchInput" type="search" class="form-control border-0 shadow-none" placeholder="Search here. . ." />
                ...
                <li class="pc-h-item d-none d-md-inline-flex">
                    <form class="form-search">
                        ...
                        <input type="search" class="form-control" placeholder="Search. . ." id="serchFildid">
                        <button class="btn btn-light-secondary btn-search" style="padding: 0" @click.prevent="handleSearch"><kbd>ctrl+k</kbd></button>
                    </form>
                </li>
            </ul>
        </div>
        <div class="ms-auto">
            <ul class="list-unstyled">
                <BDropdown variant="link-secondary" class="pc-h-item" toggle-class="text-reset dropdown-btn arrow-none dropdown p-0" menu-class="dropdown-menu-end dropdown-qta p-0 mt-3" aria-haspopup="true">
                    <template #button-content><span class="text-muted pc-head-link"><i class="ph-duotone ph-circles-four"></i></span>
                    </template>
                ...
                <BDropdown variant="link-secondary" class="pc-h-item" toggle-class="text-reset dropdown-btn arrow-none p-0" menu-class="dropdown-menu-end" aria-haspopup="true" :offset="{ alignmentAxis: -150, crossAxis: 0, mainAxis: 20 }">
                    <template #button-content><span class="text-muted pc-head-link"><i :class="currentMode === 'dark' ? 'ph-duotone ph-moon' : (currentMode === 'light' ? 'ph-duotone ph-sun-dim' : 'ph-duotone ph-cpu')"></i></span>
                    </template>
                ...
                <rightBar />
                <BDropdown variant="link-secondary" auto-close="outside" class="pc-h-item card-header-dropdown pb-0" toggle-class="text-reset dropdown-btn arrow-none p-0" menu-class="dropdown-menu-end" aria-haspopup="true" :offset="{ alignmentAxis: -140, crossAxis: 0, mainAxis: 20 }">
                    <template #button-content><span class="text-muted pc-head-link"><i class="ph-duotone ph-diamonds-four"></i></span>
                    </template>
                    <a href="#!" class="dropdown-item">
                ...
                <BDropdown v-model="show" variant="link-secondary" auto-close="outside" class="pc-h-item card-header-dropdown pb-0" toggle-class="text-reset dropdown-btn arrow-none p-0 me-0" menu-class="dropdown-menu-end dropdown-notification pc-h-dropdown" aria-haspopup="true" :offset="{ alignmentAxis: -145, crossAxis: 0, mainAxis: 20 }">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="position-relative text-muted mt-1 mb-2"><br><span class="text-truncate">Lorem Ipsum
                                                    has been the industry's standard dummy text ever since the 1500s.</span></p>
                                        </div>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="position-relative text-muted mt-1 mb-2"><br><span class="text-truncate"><strong> Jonny aber
                ...
                <BDropdown variant="link-secondary" auto-close="outside" class="pc-h-item header-user-profile card-header-dropdown py-0" toggle-class="text-reset dropdown-btn arrow-none me-0" menu-class="dropdown-menu-end dropdown-user-profile dropdown-menu-end pc-h-dropdown" aria-haspopup="true" :offset="{ alignmentAxis: -145, crossAxis: 0, mainAxis: 20 }">
