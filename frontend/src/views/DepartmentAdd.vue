    ...
    methods: {
        async ValidateGlobalForm() {
            ...
            if (!isFormValid) {
              ...
              Swal.fire({
                title: 'Ajout',
                html: `Voulez-vous vraiment Ajouter un departement avec le libellé suivant : 
                <div class="row mt-3">
...
<template>
    <Layout>
        <pageheader title="Ajouter un Departement" pageTitle="Departements" />
