...
export default {
    ...
    methods: {
        ...
        deleteUnit(id) {
            Swal.fire({
                title: 'Supression',
                html: `Voulez-vous vraiment supprimer l'utilisateur n°<strong>${id}</strong> 
                `,
                icon: 'warning',
...
<template>
    <Layout>
        <pageheader title="Liste des Utilisateur" pageTitle="Utilisateur" />
