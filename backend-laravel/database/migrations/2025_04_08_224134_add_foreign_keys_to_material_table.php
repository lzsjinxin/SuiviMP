...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('material', function (Blueprint $table) {
            $table->foreign(['id_supplier'], 'material_tier_fk')->references(['id'])->on('tier')->onUpdate('RESTRICT')->onDelete('RESTRICT');
            ...
            $table->foreign(['id_stock'], 'material_stock_fk')->references(['id'])->on('stock')->onUpdate('RESTRICT')->onDelete('RESTRICT');
        });
    }
    ...
    {
        Schema::table('material', function (Blueprint $table) {
            $table->dropForeign('material_tier_fk');
